...
HD_PWD='C:/Users/kaixunwang/Rangehood/Rangehood.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Rangehood_Top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Rangehood_Top.tcl
