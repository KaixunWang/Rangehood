...
HD_PWD='C:/Users/kaixunwang/Rangehood/Rangehood.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Rangehood_Top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Rangehood_Top.tcl -notrace
